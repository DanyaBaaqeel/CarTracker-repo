...
public class DriverCars extends RootActivity {
    ArrayList<Car> data;
    JSONObject answer;
    @Override
        ...
        class JsonOpener extends AsyncTask<String, Void, String> {
                ...
                try {
                    {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                CarsAdapter mAdapter = new CarsAdapter(data ,DriverCars.this, false);
                                RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(DriverCars.this);
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    pars.put("service" , "getdrivercars"); // send this GET to api
                    pars.put("user_id" , SharedPrefManager.getInstance(DriverCars.this).getUser().getUser_id());
                    pars.put("password" ,SharedPrefManager.getInstance(DriverCars.this).getUser().getPassword());
