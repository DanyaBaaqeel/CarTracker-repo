...
class DriversAdapter extends BaseAdapter {
    ...
    ArrayList<Driver> cities;
    public DriversAdapter(Activity con , ArrayList<Driver> cities) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.name.setText("" + cities.get(position).getName() + "  , ID : ("+ cities.get(position).getName()+")");
        return v;
    }
